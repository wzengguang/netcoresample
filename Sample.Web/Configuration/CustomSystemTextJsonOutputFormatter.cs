...
namespace Sample.Web.Configuration
{
    ...
    {
        /// <summary>
        /// Initializes a new <see cref="CustomSystemTextJsonOutputFormatter"/> instance.
        /// </summary>
        ...
        internal static CustomSystemTextJsonOutputFormatter CreateFormatter(JsonOptions jsonOptions)
        {
            ...
            return new CustomSystemTextJsonOutputFormatter(jsonSerializerOptions);
        }
        ...
        /// </summary>
        /// <remarks>
        /// A single instance of <see cref="CustomSystemTextJsonOutputFormatter"/> is used for all JSON formatting. Any
